...
import { Box, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, Typography, IconButton, MenuItem, Tabs, Tab } from '@mui/material';
                ...
                <Box component={Paper} sx={{ p: 3 }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                        <Box sx={{ flex: 1, mr: 2 }}>
                            ...
                            <TextField select label="Prioridad" fullWidth margin="normal" value={prioridad} defaultValue="Bajo">
